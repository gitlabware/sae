		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<a href="<?php echo $this->webroot; ?>img/formatos/excel-xcobrar2.png" data-toggle="lightbox-image" title="Formato para poder cargar registros de excel"
					class="gallery-link btn btn-success"><i class="fa fa-eye"></i> Ver Formato excel</a>
					<a href="<?php echo $this->Html->url(['action' => 'gen_excel_formato']) ?>" title="Descargar formato" class="gallery-link btn btn-success"><i
				...
				<div class="table-responsive">
					<table class="table table-striped table-vcenter table-hover">
						...
						<tbody>
							...
							<tr>
								<td>
									<?php echo $ex['Excel']['modified']; ?>
								</td>
								<td>
									<?php echo $ex['Excel']['nombre']; ?>
								</td>
								<td>
									<?php echo $ex['Excel']['gestion']; ?>
								</td>
								<td>
