    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto mt-md-0 ">
                ...
                <li class="nav-item ">
                    <a class="nav-link text-muted text-muted waves-effect waves-dark" title="Ambientes" href="<?php echo $this->Html->url(array('controller' => 'Edificios', 'action' => 'ambientes')); ?>" > <i class="mdi mdi-tag-multiple"></i>
                        <div class="notify"> </div>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link text-muted text-muted waves-effect waves-dark" title="Cuentas - Bancos/Cajas" href="<?php echo $this->Html->url(array('controller' => 'Cuentas', 'action' => 'index')); ?>" > <i class="mdi mdi-bank"></i>
                        <div class="notify"> </div>
                    </a>
                </li>
                <li class="nav-item ">
