<div class="row">
  <div class="col-md-4">
    ...
    <div class="card"> 
      <img src="<?php echo $this->webroot; ?>img/placeholders/avatars/iconFolder.jpg" alt="avatar" class="card-img" style="height: 230px;">
      <!-- <img class="card-img" src="../assets/images/background/socialbg.jpg" alt="Card image"> -->
      <div class="card-img-overlay card-inverse social-profile d-flex " >
        <div class="align-self-center" style="width: 100%;"> <img src="<?php echo $this->webroot; ?>img/placeholders/avatars/iconFolder.jpg" alt="user" class="img-circle" width="100">
          <h4 class="card-title">Nombre: <?php echo $datosAmbiente['Ambiente']['nombre']; ?></h4>
          <h6 class="card-subtitle">Propietario: <?php echo $datosAmbiente['User']['nombre']; ?></h6>
          <p class="text-white">Piso: <?php echo $datosAmbiente['Piso']['nombre']; ?></p>
        </div>
      </div>
    </div>
    <!-- END Widget Header -->
      ...
      <div class="col-md-12">
        ...
        <div class="card card-outline-inverse">
          <div class="card-header">
            ...
            <h4 class="m-b-0 text-white">Representante: <?php echo $datosAmbiente['Representante']['nombre'] ?></h4>
      ...
      <?php if (!empty($conceptos[10])): ?>
        <div class="col-md-12">
          ...
          <div class="card">
            <!-- Input Grid Title -->   
            <div class="card-header">  
              <span><b>Pago por Mantenimiento</b></span>
            ...
            <!-- Block Tabs Title -->
            <div class="card-body block-content-1" style="display: none;">
      ...
      <?php if (!empty($conceptos[11])): ?>
        <div class="col-md-12">
          ...
          <div class="card">
            <!-- Input Grid Title -->            
            <div class="card-header">  
              <span><b>Pago por Alquileres</b></span>
              <div class="pull-right">
            ...
            <!-- END Input Grid Title -->
            <!-- Block Tabs Title -->
            <div class="card-body block-content-2" style="display: none;">
      ...
      <?php if (!empty($intereses[0][0])): ?>
        <div class="col-md-12">
          ...
          <div class="card">
            <!-- Input Grid Title -->            
            <div class="card-header">
              <span><b>Pago por Intereses</b></span>
              <div class="pull-right">
            ...
            <div id="form-1" class="card-body" style="display: none;">
              <div class="form-group">
                <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            ...
            <span><b>Pago por Ascensor y Traslados</b></span> <label style="font-family: bold;">TOTAL:<label id="lab-total-ascensor">0.00</label></label>
          </div>
          <div id="form-2" class="card-body" style="display: none;">
            <div class="form-group">
              <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            ...
            <span><b>Multas Inasistencias Asamblea</b></span> <label style="font-family: bold;">TOTAL:<label id="lab-total-multas">0.00</label></label>
          </div>
          <div id="form-3" class="card-body" style="display: none;">
            <div class="form-group">
              <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            ...
            <span><b>Otros</b></span> <label style="font-family: bold;">TOTAL:<label id="lab-total-otros">0.00</label></label>
          </div>

          <div id="form-4" class="card-body" style="display: none;">
            <div class="form-group">
              <div class="row">
